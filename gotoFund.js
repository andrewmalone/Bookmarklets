...
var header = create("h3",{},"Go to Fund");
...
$("#fund").addEventListener("keyup", up, false);

function up(e) {
    if (e.ctrlKey && e.keyCode == 86) {
        var urlstring = "/gmas/dispatch?ref=%2Fproject%2FSCR0001ProjectSearch.jsp&formName=ProjectSearchForm&fundValue=true&projectSegmentSearchText=";
        //$(this).dialog("close");
